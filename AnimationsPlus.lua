...
custom_vroot = menu.list(props_root, "Custom", {""}, "Custom extra emotes added for more fun")
...
stopanims_root = menu.list(menu.my_root(), "Stop Animations", {""}, "Stop animations options")
...
menu.action(custom_vroot, "Aim Bomb", {""}, "", function(on_click)
    request_model_load(-1466745439)
    attachto(0.12, 0.32, 1.56, players.user(), 0.0, 0.0, 0.0, -1466745439, 60309, false, false)
	play_anim("weapons@heavy@rpg", "aim_med_loop", -1)
end)

menu.action(custom_vroot, "Bouquet 2", {""}, "", function(on_click)
    request_model_load(176971574)
    attachto(-0.29, 0.40, -0.02, players.user(), -90.0, -90.0, 0.0, 176971574, 24817, false, false)
    play_anim("anim@heists@box_carry@", "idle", -1)
end)

menu.action(custom_vroot, "Candy Offer", {""}, "", function(on_click)
    request_model_load(-984269803)
    --attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, -984269803, 6286, false, false)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, -984269803, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Chicken Offer", {""}, "", function(on_click)
    request_model_load(-1898057898)
    attachto(0.09, 0.10, -0.01, players.user(), 0.0, 0.0, 0.0, -1898057898, 57005, false, false)
    play_anim("missmic4premiere", "interview_short_lazlow", -1)
end)

menu.action(custom_vroot, "Chocolate Offer", {""}, "", function(on_click)
    request_model_load(921283475)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, 921283475, 6286, false, false)
    play_anim("missmic4premiere", "interview_short_lazlow", -1)
end)

menu.action(custom_vroot, "Ciggarette Offer", {""}, "", function(on_click)
    request_model_load(1079465856)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, 1079465856, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(accessories_vroot, "Feet Statue", {""}, "", function(on_click)
    request_model_load(-2059029335)
    attachto(0.0, -0.08, 0.0, players.user(), 0.0, 0.0, 0.0, -2059029335, 28422, false, false)
    play_anim("anim@scripted@freemode@postertag@graffiti_spray@male@", "shake_can_idle_male", -1)
end)

menu.action(accessories_vroot, "Female Statue", {""}, "", function(on_click)
    request_model_load(2147205602)
    attachto(0.0, -0.08, 0.0, players.user(), 0.0, 0.0, 0.0, 2147205602, 28422, false, false)
    play_anim("anim@scripted@freemode@postertag@graffiti_spray@male@", "shake_can_idle_male", -1)
end)

menu.action(custom_vroot, "Flag Bearer (Germany)", {""}, "", function(on_click)
    request_model_load(-1207959739) -- -1207959739 (Pole)
    attachto(-0.28, 0.16, -0.30, players.user(), -10.0, -40.0, -140.0, -1207959739, 24817, false, false)
    request_model_load(1970675376) -- 1970675376 (Flag)
    attachto(-0.28, 0.16, -0.30, players.user(), -10.0, -40.0, -140.0, 1970675376, 24817, false, false)
	play_anim("weapons@melee_2h", "idle", -1)
end)

menu.action(custom_vroot, "Flag Bearer (Russia)", {""}, "", function(on_click)
    request_model_load(-1207959739) -- -1207959739 (Pole)
    attachto(-0.28, 0.16, -0.30, players.user(), -10.0, -40.0, -140.0, -1207959739, 24817, false, false)
    request_model_load(908104950) -- -908104950 (Flag)
    attachto(-0.28, 0.16, -0.30, players.user(), -10.0, -40.0, -140.0, -908104950, 24817, false, false)
	play_anim("weapons@melee_2h", "idle", -1)
end)

menu.action(custom_vroot, "Football", {""}, "", function(on_click)
    request_model_load(-717142483)
    attachto(-0.03, 0.01, 0.05, players.user(), 0.0, 0.0, -90.0, -717142483, 60309, false, false)
	play_anim("anim@sports@ballgame@handball@", "ball_idle", -1)
end)

menu.action(custom_vroot, "Give Bowl (Chips/Crips)", {""}, "", function(on_click)
    request_model_load(2018525338)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, 2018525338, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Give Bowl (Peanuts)", {""}, "", function(on_click)
    request_model_load(-1669330389)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, -1669330389, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Give Bowl (Soup)", {""}, "", function(on_click)
    request_model_load(-295727581)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, -295727581, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Give Cuffs", {""}, "", function(on_click)
    request_model_load(1070220657)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, 1070220657, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Give Dildo", {""}, "", function(on_click)
    request_model_load(1333481871)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, 1333481871, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Give Dildo 2", {""}, "", function(on_click)
    request_model_load(-422877666)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, -422877666, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Give Letter", {""}, "", function(on_click)
    request_model_load(406712611)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, 406712611, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Give Lipstick", {""}, "", function(on_click)
    request_model_load(-1265049850)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, 180.0, -1265049850, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Give Panties", {""}, "", function(on_click)
    request_model_load(183572309)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, 183572309, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Give Shoe", {""}, "", function(on_click)
    request_model_load(1536669612)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, 1536669612, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Hold Flowers (Pink)", {""}, "", function(on_click)
    request_model_load(562366042)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, 562366042, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Hold Flowers (Aloevera)", {""}, "", function(on_click)
    request_model_load(-73263722)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, -73263722, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Hold Flowers (Purple)", {""}, "", function(on_click)
    request_model_load(-2032546125)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, -2032546125, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Money Plant", {""}, "", function(on_click)
    request_model_load(-950054773)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, -950054773, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Show Busker Hat", {""}, "", function(on_click)
    request_model_load(-1153241480)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, -1153241480, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Show Book", {""}, "", function(on_click)
    request_model_load(-1483715345)
    attachto(-0.08, 0.44, -0.02, players.user(), 0.0, -90.0, 170.0, -1483715345, 24817, false, false)
    play_anim("impexp_int-0", "mp_m_waremech_01_dual-0", -1)
end)

menu.action(custom_vroot, "Show Book 2", {""}, "", function(on_click)
    request_model_load(-1483715345)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, -1483715345, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Show Sponge", {""}, "", function(on_click)
    request_model_load(1411425721)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, 1411425721, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Call Me", {""}, "", function(on_click)
    request_model_load(1214755619)
    attachto(0.11, 0.0, -0.02, players.user(), 75.0, 6.0, 180.0, 1214755619, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Makeup Brush", {""}, "", function(on_click)
    request_model_load(-2098426548)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, -2098426548, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Credit Card", {""}, "", function(on_click)
    request_model_load(-875075437)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, -875075437, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Passport", {""}, "", function(on_click)
    request_model_load(-1750183478)
    attachto(0.11, 0.0, -0.02, players.user(), 102.0, 6.0, -8.0, -1750183478, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

menu.action(custom_vroot, "Show Gold Box", {""}, "", function(on_click)
    request_model_load(1489572967)
    attachto(0.0100, -0.1000, -0.1590, players.user(), 20.0000007, 0.0, 0.0, 1489572967, 6286, false, false)
    play_anim("anim@heists@box_carry@", "idle", -1)
end)
...
menu.action(foodanddrinks_vroot, "Apple (Giving)", {""}, "", function(on_click)
    request_model_load(2987815129)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, 2987815129, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)
...
menu.action(foodanddrinks_vroot, "Banana (Giving)", {""}, "", function(on_click)
    request_model_load(532565818)
    attachto(0.091, 0.0, 0.0, players.user(), 0.0, 160.0, 90.0, 532565818, 6286, false, false)
    play_anim("misscarsteal1leadinout@i_fought_the_law", "leadin_loop_devin", -1)
end)

------------TODO: TESTING THIS DO NOT TOUCH------------------------
-- menu.action(foodanddrinks_vroot, "Give Banana", {""}, "", function(on_click)
--     request_model_load(532565818)
--     attachto(0.09, 0.03, -0.01, players.user(), -80.0, 0.0, -6.0, 532565818, 57005, false, false)
--     play_anim("missmic4premiere", "interview_short_lazlow", -1)
-- end)
-----------------------------END-----------------------------------
...
menu.action(scenarios_vroot, "Flag Bearer (USA)", {""}, "", function(on_click)
    request_model_load(2808222752) -- 2808222752
...
menu.action(scenarios_vroot, "Wedding Proposal", {""}, "", function(on_click)
	...
	request_model_load(-908427590) -- original: -1407761612
    -- original: attachto(0.048, 0.105, 0.013, players.user(), -10.0, -90.0, -140.0, -1407761612, 28422, false, false)
    attachto(0.048, 0.105, 0.013, players.user(), 50.0, -90.0, -140.0, -908427590, 28422, false, false)
end)

----- STOP ANIMATIONS -----

menu.action(stopanims_root, "Stop animation", {"stopanim"}, "", function(on_click)
    TASK.CLEAR_PED_TASKS(PLAYER.PLAYER_PED_ID())
    TASK.CLEAR_PED_SECONDARY_TASK(PLAYER.PLAYER_PED_ID())
end)

menu.action(stopanims_root, "Force Stop animation", {"forcestopanim"}, "", function(on_click)
    TASK.CLEAR_PED_TASKS_IMMEDIATELY(PLAYER.PLAYER_PED_ID())
end)

menu.action(stopanims_root,"Detach objects", {"detachobjects"}, "",function(on_click)
	removeObjectsFromPlayer(PLAYER.PLAYER_ID())
end)

local X_HandsUp = true
menu.toggle(stopanims_root, "Hold X to Handsup", {""}, "hold X to handsup, this will also stop running animation", function (on_change)
    ...
    if X_HandsUp then
        if PAD.IS_CONTROL_PRESSED(1, 323) then
            ...
            if not ENTITY.IS_ENTITY_PLAYING_ANIM(PLAYER.PLAYER_PED_ID(), "random@mugging3", "handsup_standing_base", 3) then
                ...
                removeObjectsFromPlayer(PLAYER.PLAYER_ID()) -- remove objects from player
